...
import fast.cleaner.battery.cleanify.Classes.Apps;
import fast.cleaner.battery.cleanify.Cpu_Scanner;
import fast.cleaner.battery.cleanify.MainActivity;
import com.example.intagpc.myapplication.R;
import fast.cleaner.battery.cleanify.RecyclerAdapter;
...
//                        getActivity().unregisterReceiver(batteryReceiver);
                                    ...
                                    showmain.setTextColor(Color.parseColor("#fc7a02"));
                                    showsec.setText("CPU Temperature is GOOD");
                                    showsec.setTextColor(Color.parseColor("#fc7a02"));
