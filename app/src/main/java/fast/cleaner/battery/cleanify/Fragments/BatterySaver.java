...
import fast.cleaner.battery.cleanify.Noraml_Mode;
import fast.cleaner.battery.cleanify.PowerSaving_popup;
import com.example.intagpc.myapplication.R;
import fast.cleaner.battery.cleanify.Ultra_PopUp;
...
//            mWaveLoadingView.setBottomTitle(level+"%");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            mWaveLoadingView.setBorderColor(Color.parseColor("#2499E0"));
